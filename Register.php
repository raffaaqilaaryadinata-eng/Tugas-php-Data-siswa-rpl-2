...
nama" required></td></tr>
 <tr>
 <td>Email</td>
 <td><input type="email" name="email" placeholder="Masukkan 
email" required></td>
 </tr>
 <tr>
 <td>Jurusan</td>
...
Perangkat Lunak</option>
 ...
 <option value="Teknik Sepeda Motor">Teknik Sepeda 
Motor</option>
 </select>
 </td>
 </tr>
 <tr>
 <td>Password</td>
 <td><input type="password" name="password" placeholder="Buat 
